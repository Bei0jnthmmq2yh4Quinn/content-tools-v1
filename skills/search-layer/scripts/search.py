...
@_throttled
def search_searxng(query: str, num: int = 10, freshness: str = None,
                   base_url: str = "http://127.0.0.1:8888/search") -> list:
...
def execute_search(query: str, mode: str, keys: dict, num: int,
    ...
    if mode == "fast":
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=4) as pool:
            ...
            futures[pool.submit(search_searxng, query, num, freshness)] = "searxng"
            if "exa" in keys:
